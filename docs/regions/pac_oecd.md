...
!!! abstract "Sources & provenance"
    ...
    **Companion-only:** the Pacific OECD physical-setting prose, the
    paired-shifts mini-hero plot computed at Pacific OECD aggregate,
    the regional signed structural–parametric angle figure and the
    "cells where Pacific OECD departs from world" table extend the
