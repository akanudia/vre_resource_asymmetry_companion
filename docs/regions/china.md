...
!!! abstract "Sources & provenance"
    ...
    **Companion-only:** the China+ physical-setting prose, the
    paired-shifts mini-hero plot computed at China+ aggregate,
    the regional signed structural–parametric angle figure and the
    "cells where China+ departs from world" table extend the
