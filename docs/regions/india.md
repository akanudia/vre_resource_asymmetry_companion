...
!!! abstract "Sources & provenance"
    ...
    **Companion-only:** the India+ physical-setting prose, the
    paired-shifts mini-hero plot computed at India+ aggregate,
    the regional signed structural–parametric angle figure and the
    "cells where India+ departs from world" table extend the
