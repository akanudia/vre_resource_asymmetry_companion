...
!!! abstract "Sources & provenance"
    ...
    **Companion-only:** the Reforming Economies physical-setting prose, the
    paired-shifts mini-hero plot computed at Reforming Economies aggregate,
    the regional signed structural–parametric angle figure and the
    "cells where Reforming Economies departs from world" table extend the
