...
Gas prices in absolute terms stay in a narrow band across categories
(roughly USD2010 5–8 / GJ globally by 2050), with C7 a touch higher
than C1–C4 — under weak policy, gas demand grows and prices rise on
ordinary market dynamics. The category dispersion in gas is modest
compared with the within-category q25–q75 spread.

Biomass tells the opposite story and is the most striking single
signal on this page. Under ambitious mitigation (C1, C2) biomass
demand from BECCS drives prices into the USD2010 15–20 / GJ range by
2050, while under weak policy (C7) biomass stays near USD2010 2 / GJ.
That ~10× fan-out across categories is the scarcity-rent fingerprint
of BECCS deployment in the AR6 ensemble. Where AR6 scenario coverage
is thin (visible as kinked lines or wide q25–q75 bands), the
