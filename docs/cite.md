...
@article{vre_resource_asymmetry_2026,
  ...
  year    = {2026},
  note    = {Under review. DOI to be assigned upon acceptance.},
}
```

## Companion site

If the figures, prose, or data on this site are the direct source for a
...
Once the manuscript is accepted, this page will be updated with the final
DOI, journal issue/volume, page numbers, and a Zenodo-archived snapshot of
the site at the time of acceptance.
